...
MSG_ERR_PROMPT_TEMPLATE_MISSING="❌ Prompt template meeting-notes.md not found (searched session/user/default paths), cannot generate notes"
...
MSG_FIELD_STOP_MANUAL="   Auto-stop: off (stop manually)"
...
MSG_TAP_STALL_RETRY="⚠ No system-audio data captured (Process Tap callback did not start); restarting audio pipeline (attempt %s/%s)..."
MSG_ERR_TAP_STALL="❌ System-audio capture produced no data after repeated attempts; the recording would be silent. Run %s setup to check permissions, or try start again."
...
# -- Process Tap permission check --
MSG_SETUP_TAP_UNSUPPORTED="i  Process Tap not supported on this Mac (requires macOS 14.4+); recording will use BlackHole"
MSG_SETUP_TAP_PROBING="Checking system audio capture (about 3s, a chime will play)..."
MSG_SETUP_TAP_OK="OK: system audio capture works; recording will use Process Tap (output device untouched)"
MSG_SETUP_TAP_SILENT_HEADER="WARNING: captured audio is all silence - your terminal app lacks System Audio Recording permission"
MSG_SETUP_TAP_SILENT_WHY="   (some terminals, e.g. Ghostty, never show the permission dialog; add it manually)"
MSG_SETUP_TAP_GUIDE_1="   1. Opened for you: System Settings > Privacy & Security > Screen & System Audio Recording"
MSG_SETUP_TAP_GUIDE_2="   2. Under 'System Audio Recording Only', click + and add your terminal app (Ghostty / Terminal / iTerm)"
...
MSG_SETUP_STEP_TAP="[1/4] Check system audio capture permission (Process Tap)"
MSG_SETUP_STEP_ZOOM="[2/4] Configure Zoom"
...
MSG_USAGE_HIGHLIGHT="  mark [dir]       Highlight key points in the notes (default: latest session)"
